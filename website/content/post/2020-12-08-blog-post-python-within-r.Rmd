...
If your curious, here is the SolidWorks CAD for the DIY home exercise peddling machine. It's designed so that during the pandemic, people can pedal while working from their desk. The mechanism at the top allows for the user to change the resistance on the internal pulleys and belts so the user can get a more intense workout if they want. 
